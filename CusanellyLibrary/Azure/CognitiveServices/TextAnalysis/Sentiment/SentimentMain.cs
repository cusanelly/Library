...
namespace CusanellyLibrary.Azure.CognitiveServices.TextAnalysis.Sentiment
{
    class SentimentMain
    {
        ...
        internal async Task<SentimentBatchResult> GetSentimentCall(List<Input> list,
            ...
            ITextAnalyticsAPI client)
        {
            ...
            string textlang = "";
            string textval = "";
            List<MultiLanguageInput> sentimentlist = new List<MultiLanguageInput>();
            for (int i = 0; i < documents.Count; i++)
            {
                ...
                sentimentlist.Add(new MultiLanguageInput() { Id = textid, Text = textval, Language = textlang });
            }
            return await SentimentCall(client, sentimentlist);
        }
