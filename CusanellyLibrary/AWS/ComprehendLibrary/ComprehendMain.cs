...
using CusanellyLibrary.AWS.ComprehendLibrary.Entities;
using CusanellyLibrary.AWS.ComprehendLibrary.KeyPhrase;
using CusanellyLibrary.AWS.ComprehendLibrary.Language;
using CusanellyLibrary.AWS.ComprehendLibrary.Sentiment;
using System;
using System.Collections.Generic;
using System.Text;
using System.Threading.Tasks;

namespace CusanellyLibrary.AWS.ComprehendLibrary
{
    class ComprehendMain
    {
